...
document.addEventListener('DOMContentLoaded', () => {
  ...
  fetch('http://ip-api.com/json')
      ...
      .then(data => {
          ipAddressElement.textContent = `IP Address: ${data.query || 'Not Available'}`;
          locationElement.textContent = `Location: ${data.city || 'Unknown'}, ${data.region || 'Unknown'}, ${data.country || 'Unknown'}`;
          ispElement.textContent = `ISP: ${data.isp || 'Unknown'}`;
      })
      .catch(error => {
